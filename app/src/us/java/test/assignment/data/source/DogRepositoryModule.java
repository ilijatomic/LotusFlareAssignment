...
import test.assignment.data.source.remote.RemoteDogRetrofitDataSource;
...
public class DogRepositoryModule {
    ...
    @ApplicationScope
    @Provides
    RemoteDogDataSource provideRemoteDataSource(RetrofitRestApiModule.DogService dogService) {
        return new RemoteDogRetrofitDataSource(dogService);
    }
}
